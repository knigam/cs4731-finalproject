...
public class MyLevel extends Level{
	//Store information about the level
		...
		private int[] buildPercentages = new int[5];
	    ...
	    {
	        this(width, height);
	        buildPercentages = new int[] {20,20,20,20,20};
	    ...
	    public void setBuildPercentages(int [] buildPercentages){
	    	this.buildPercentages = buildPercentages;
	    }

	    public void setMaximums(int maxLength){
	    	maxStraight = buildPercentages[0]*maxLength/100;
	    	maxHills = buildPercentages[1]*maxLength/100;
